        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('Tambah Destinasi Baru') }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kota" placeholder="{{ __('Kota') }}" name="kota" value="{{ old('kota') }}" />
                    </div>
                    <div class="form-group">
                        <label for="provinsi">{{ __('Provinsi') }}</label>
                        <input type="text" class="form-control" id="provinsi" placeholder="{{ __('Provinsi') }}" name="provinsi" value="{{ old('provinsi') }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="durasi" placeholder="{{ __('Durasi') }}" name="durasi" value="{{ old('durasi') }}" />
                    </div>
                    <div class="form-group">
