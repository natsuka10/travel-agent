            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.testimonials.create') }}" class="btn btn-success">
                        ...
                        <span class="text">{{ __('Testimoni Baru') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="data-table" class="table table-bordered table-striped table-hover datatable datatable-role" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $testimonial->id }}">
                                ...
                                <td>
                                    <a href="{{Storage::url($testimonial->photo)}}"></a>
                                    <img src="{{Storage::url($testimonial->photo)}}" width="100px" alt="">
                                </td>
                                <td>{{ $testimonial->nama}}</td>
                                <td>{{ $testimonial->judul }}</td>
                                <td>
